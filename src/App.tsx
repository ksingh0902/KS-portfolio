...
export function App() {
  return (
    <div className="relative min-h-screen bg-[#070a10] text-slate-100 flex flex-col font-sans selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <main className="flex-grow z-10 space-y-8 sm:space-y-12">
        <Hero />
        <About />
        <TechnicalExpertise />
        <Architecture />
